...
<ul>
<li>点击右上角登录，进入<strong>密钥管理配置</strong>界面</li>
...
<h2 id="填写密钥" tabindex="-1"><a class="header-anchor" href="#填写密钥" aria-hidden="true">#</a> 填写密钥</h2>
<ul>
<li>按照图片填写，保存至本地就可以使用</li>
</ul>
<p><img src="https://cloud.mr90.top/hexo/4/79140172-f18a-4c28-a63e-01e9171d26ea.png" alt=""></p>
<h2 id="上传图片配置" tabindex="-1"><a class="header-anchor" href="#上传图片配置" aria-hidden="true">#</a> 上传图片配置</h2>
<ul>
<li>密钥配置完成后,开始配置首页的上传图片的设置</li>
<li>压缩默认关闭，打开后默认压缩比为80%</li>
<li>第一个上传路径 <strong>必须填写</strong> 按照左图格式填写  几级目录都可以，如果b2桶中的不存在文件夹  上传时 会自动创建文件夹</li>
</ul>
<p><img src="https://cloud.mr90.top/hexo/5/ae1490c5-7272-4d36-a19e-bcff4e85c781.png" alt=""></p>
<h2 id="图床管理配置" tabindex="-1"><a class="header-anchor" href="#图床管理配置" aria-hidden="true">#</a> 图床管理配置</h2>
<ul>
<li>图片文件夹目录为图床管理界面下的默认检索地址，有两种设置方式 手动输入和自动填写 <strong>推荐手动输入</strong>
<img src="https://cloud.mr90.top/hexo/5/efcf7f6e-2f4f-4276-9de4-6433aa3bc8cb.png" alt=""></li>
</ul>
</div></template>
