<!--
 * @Author: Harry
 * @Date: 2022-07-06 11:30:05
 * @LastEditors: harry
 * @Github: https://github.com/rr210
 * @LastEditTime: 2022-07-06 12:19:04
 * @FilePath: \docs\docs\.vuepress\theme\LayOut.vue
-->
<template>
  <ParentLayout>
    <template #page-bottom>
      <div class="page-nav">
        ...
        <!-- Twikoo -->
        <div id="twikoo"></div>
        <component :is="'script'" src="https://cdn.staticfile.org/twikoo/1.5.11/twikoo.all.min.js" ref="twikooJs">
        </component>
      </div>
    </template>
  </ParentLayout>
...
const envId = 'twikoo-6gul6t4a61223d84'
export default {
  name: 'Layout',
  components: {
    ParentLayout
